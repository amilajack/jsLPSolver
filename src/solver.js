...
Model.prototype.addVariable = function (
  cost,
  id,
  isInteger,
  isUnrestricted,
...
Model.prototype.updateConstraintCoefficient = function (
  constraint,
  variable,
  difference
) {
...
//-------------------------------------------------------------------
//-------------------------------------------------------------------
Tableau.prototype.initialize = function (
  width,
  height,
  variables,
  unrestrictedVars
...
Tableau.prototype.updateConstraintCoefficient = function (
  constraint,
  variable,
  difference
) {
...
Constraint.prototype.setVariableCoefficient = function (
  newCoefficient,
  variable
) {
  const varIndex = variable.index;
